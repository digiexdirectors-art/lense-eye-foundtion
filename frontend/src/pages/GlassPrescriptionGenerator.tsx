            ...
            <tr>
              <td style={{ border: 'none' }}>
                <div className="prescription-header" style={{
                  ...
                  <div className="clinic-details" style={{ flex: 1.2, textAlign: 'right', color: '#1e293b', fontSize: '0.92rem', lineHeight: '1.2', fontWeight: 500 }}>
                    ...
                    {settings.address && settings.address.split('\n').map((line: string, i: number) => (
                      <p key={i} className="clinic-address-line" style={{ margin: 0, fontWeight: 500, fontSize: '0.95rem' }}>{line.toUpperCase()}</p>
                    ))}
